...
module.exports.setRouter = (app) => {
    ...
    */
     ...
     * @apiGroup items
     * @apiVersion  1.0.0
     * @api {post} /api/v1/users/add-item api to Add item.
     *
     * @apiParam {string} authToken Authentication Token. (body/header/query params) (required)
    ...
    */
     ...
     * @apiGroup items
     * @apiVersion  1.0.0
     * @api {put} /api/v1/users/edit-item api to Update item Details.
     *
     * @apiParam {string} authToken Authentication Token. (body/header/query params) (required)
    ...
    */
     ...
     * @apiGroup items
     * @apiVersion  1.0.0
     * @api {post} /api/v1/users/delete-item api to Delete item.
     *
    ...
    */
     ...
     * @apiGroup items
     * @apiVersion  1.0.0
     * @api {post} /api/v1/users/add-sub-item api to Add sub-item.
     *
     * @apiParam {string} authToken Authentication Token. (body/header/query params) (required)
    ...
    */
     ...
     * @apiGroup items
     * @apiVersion  1.0.0
     * @api {post} /api/v1/users/add-sub-item api to edit sub-item.
     *
     * @apiParam {string} authToken Authentication Token. (body/header/query params) (required)
     * @apiParam {string} subItemName Name of the Sub item. (body params) (required)
     * @apiParam {string} itemId of the Item in which sub item has to add. (body params) (required)
    ...
    */
     ...
     * @apiGroup items
     * @apiVersion  1.0.0
     * @api {post} /api/v1/users/add-sub-item api to delete sub-item.
     *
     * @apiParam {string} authToken Authentication Token. (body/header/query params) (required)
    ...
    */
     ...
     * @apiGroup items
     * @apiVersion  1.0.0
     * @api {post} /api/v1/users/replace-item api to replace sub-item.
     *
     * @apiParam {string} authToken Authentication Token. (body/header/query params) (required)
