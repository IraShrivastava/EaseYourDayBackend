...
module.exports.setRouter = (app) =>{
    ...
    */
     ...
     * @apiParam {string} authToken Authentication Token. (body/header/query params) (required)
     * @apiParam {string} listName Name of the List. (body params) (required)
     * @apiParam {string} userId of the user creating ToDo. (body params) (required)
     * @apiParam {string} creatorName User Name of the user creating ToDo. (body params) (required)
     * @apiParam {string} modifierId User Id of the user modifying ToDo. (body params) (required)
     * @apiParam {string} modifierName User Name of the user modifying ToDo. (body params) (required)
     * @apiParam {string} privacy Mode of the ToDo either true or false. (body params) (required)
     * @apiParam {string} listId an unique id for list in ToDo. (body params) (required)
     *
     * @apiSuccess {object} myResponse shows error status, message, http status code, result.
     * 
     * @apiSuccessExample {object} Success-Response:
