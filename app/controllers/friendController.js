...
let unFriend = async (req, res) => {
    console.log("PARAMS "+req.params.senderId)
    console.log("BODY "+req.body.senderId)
    ...
    try {
        await new Promise(async (resolve) => {
            ...
            console.log(senderOptions.$pull.friends.friendId+"    "+senderOptions.$pull.friends.friendName)
