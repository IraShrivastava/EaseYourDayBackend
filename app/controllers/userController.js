                ...
                newUser.save((err, newUser) => {
                    if (err) {
                        ...
                        let emailOptions = {
                            ...
                            subject: 'Welcome to Ease Your Day ',
                            html: `<b> Dear ${newUserObj.firstName}</b><br> Hope you are doing well. 
                            <br>Welcome to our Ease Your Day App <br>
                            Please click on following link to verify your account with Ease Your Day.<br>
        ...
        if(check.isEmpty(details)){
            ...
            let userDetails = details.toObject();
                        let emailOptions = {
                            ...
                            <br>Welcome to our Ease Your Day App <br>
                            Please click on following link to Reset you pasword with Ease Your Day.<br>
